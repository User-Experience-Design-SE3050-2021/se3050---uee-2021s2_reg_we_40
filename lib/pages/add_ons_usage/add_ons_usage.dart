...
class AddOnsUsage extends StatefulWidget {
  const AddOnsUsage({Key key}) : super(key: key);

  @override
  _AddOnsUsageState createState() => _AddOnsUsageState();
  
}

class _AddOnsUsageState extends State<AddOnsUsage> {
  List<charts.Series<Usage, String>> seriesPieData =
      List<charts.Series<Usage, String>>();
  var pieData = [
    new Usage('Remains', 50, Color(0xff1D89CF)),
    new Usage('Used', 50, Color(0xff939393))
  ];

  List<charts.Series<Usage, String>> seriesPieData2 =
      List<charts.Series<Usage, String>>();
  var pieData2 = [
    new Usage('Remains', 87, Color(0xff1D89CF)),
    new Usage('Used', 13, Color(0xff939393))
  ];
