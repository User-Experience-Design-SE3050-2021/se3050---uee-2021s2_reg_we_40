...
class ExtraGBUsage extends StatefulWidget {
  const ExtraGBUsage({Key key}) : super(key: key);

  @override
  _ExtraGBUsageState createState() => _ExtraGBUsageState();
  
}

class _ExtraGBUsageState extends State<ExtraGBUsage> {
  List<charts.Series<Usage, String>> seriesPieData =
      List<charts.Series<Usage, String>>();
  var pieData = [
    new Usage('Used', 0, Color(0xff1D89CF)),
    new Usage('Remains', 100, Color(0xff939393))
  ];
